...
public class ShipStats : MonoBehaviour {
    ...
    public void TakeDamage(float damage) {
        if (damage > 0f) {
            ...
            Debug.Log("Ustawiono wartoœæ HP na: " + CurrentHP);
        } else {
            Debug.Log("Nie mo¿esz zadaæ statkowi mniej ni¿ 0 dmg");
        }
    }
    ...
    public void Heal(float amount) {
        if (amount > 0f) {
            ...
            Debug.Log("Nie mo¿esz uleczyæ statku za mniej ni¿ 0HP");
        }
    }
    ...
    public void UseEnergy(float amount) {
        if (amount > 0f) {
            ...
            Debug.Log("Ustawiono wartoœæ Paliwa na: " + CurrentEnergy);
        }
        else {
            Debug.Log("Nie mo¿esz spaliæ mniej ni¿ 0 jednostek paliwa");
        }
    }
    ...
    public void AddEnergy(float amount) {
        if (amount > 0f) {
            ...
            Debug.Log("Nie mo¿esz zatankowaæ statku za mniej ni¿ 0 jednostek paliwowych");
        }
    }
